...
def predict():
    ...
    model = pickle.load(open("modeltrialrf.sav", "rb"))
    ...
    if single == 1:
        o1 = "Be Aware!! This customer is likely to be churned"
        o2 = "With {} % Confidence. ".format(probablity * 100)
    else:
        o1 = "Great!! This customer is likely to continue"
        o2 = "With {} % Confidence.  ".format(probablity * 100)
